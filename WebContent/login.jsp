	...
	<div id="wrap">
        ...
        <div id="container">
            <div class="content holder">
                ...
                <div class="box">
                	<div <%= httpServletRequest.getParameter("valida") != null?"class='status erro'":"class='status'"%> ><p><%= httpServletRequest.getParameter("valida") == null?"Informe seu Usu·rio e Senha":"Seus Dados S„o Invalidos"%></p></div>
